  ...
  return (
    <div className="flex items-center gap-1 sm:gap-3">
      <button
        ...
        className="hidden rounded-lg p-2 text-on-surface-variant transition-all hover:bg-surface-container hover:text-[#25D366] sm:inline-block"
      >
      ...
      >
        ...
        {likesCount > 0 && (
          <span className="hidden text-xs font-bold tabular-nums sm:inline">{likesCount}</span>
        )}
      </button>
      <button
        onClick={scrollToTributes}
        className="whitespace-nowrap rounded-full bg-primary px-4 py-2 font-serif font-medium text-on-primary transition-all hover:bg-[#3d4d41] dark:hover:bg-primary-fixed-dim sm:px-6"
      >
        <span className="sm:hidden">Homenagem</span>
        <span className="hidden sm:inline">Deixar Homenagem</span>
      </button>
      <button
        onClick={() => setShowReport(true)}
        title="Denunciar este memorial"
        className="hidden rounded-lg p-2 text-on-surface-variant transition-all hover:bg-surface-container hover:text-error sm:inline-block"
      >
